...
def _cpu_percent() -> float:
    try:
        import psutil
        # interval=None — non-blocking, returns since last call or
        # instant measurement. Previous 0.1 blocked the thread for 100ms,
        # which is dangerous in the main agent loop.
