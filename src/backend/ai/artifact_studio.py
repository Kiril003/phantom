...
ELITE_SYSTEM_PROMPT = (
    ...
    "• ПРИСТРІЙ: тач-екран 1024×600, темний інтерфейс (фон близько #0b0f14). "
    "Інтерактивні елементи — мінімум 44×44px. Працюй і в компактній картці "
    "(~1000×300), і на повний екран.\n"
