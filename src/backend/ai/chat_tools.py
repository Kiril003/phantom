...
CHAT_DATA_TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            "Створити нову подію у календарі. start_at у ISO 8601 або у "
            "простій формі: 'завтра 14:00', 'сьогодні 18:30', '2026-04-25 10:00'."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "start_at": {
                    "type": "string",
                    "description": "Початок: ISO 8601 або природна мова.",
                },
                "end_at": {
                    "type": "string",
                ...
                "notes": {
                    "type": "string",
                    "description": "Опис / нотатки (опційно).",
                },
            },
