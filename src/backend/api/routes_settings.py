...
CATEGORY_SPEC: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "keys": [
            ...
            "ambient_guardian_interval_s",
            "ambient_aqi_unhealthy",
            "ambient_aqi_hazardous",
...
LABEL_OVERRIDES: dict[str, str] = {
    ...
    "ui_color_cyan": "Акцент — ФОКУС",
    "ui_color_warning": "Акцент — СОН",
    "ui_color_success": "Акцент — ПРИВИД",
    "ui_color_danger": "Акцент — ВАРТА",
    ...
    "security_max_pin_attempts": "Максимум спроб PIN",
    "security_lockout_duration_m": "Блокування (хв)",
    "security_dangerous_cmd_confirm": "Підтвердження небезпечних команд",
    "security_ghost_auto_encrypt": "Автошифрування ПРИВИДА",
    "sensor_batch_interval_ms": "Інтервал батчів (мс)",
    "sensor_serial_port": "Порт ESP32",
    "sensor_serial_baud": "Швидкість порту",
    ...
    "sensor_wifi_scan_enabled": "Сканування Wi-Fi",
    ...
    "ai_timeout_s": "Тайм-аут ШІ (с)",
    "ai_gemini_model": "Модель Gemini",
    "ai_gemini_api_key": "Ключ Gemini API",
    "ai_ollama_model": "Модель Ollama",
    ...
    "ambient_guardian_enabled": "Ambient-вартовий (стежить за оточенням)",
    "ambient_guardian_interval_s": "Частота сканування оточення (с)",
    "ambient_aqi_unhealthy": "Поріг нездорового повітря (AQI)",
    "ambient_aqi_hazardous": "Поріг небезпечного повітря (AQI)",
