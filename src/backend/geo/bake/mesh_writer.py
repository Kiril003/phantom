...
#
# `motorroad` СВІДОМО відсутній. RoadProfile.kt:80 його читає («motorroad=yes»
# робить трасу такою, якою людині ходити не можна), але його нема в жодному з
# двох білих списків. Додати його — означає змінити поведінку маршрутизації на
# телефоні, а це рішення власника, не пічки.
#
# Останні пʼять ключів (lanes … destination) у головному дереві компаньйона
# сьогодні НЕ читає ніхто: v2-й RoadWayCodec.ROUTING_KEYS має 17 ключів. Вони
# тут, щоб пакети з обох пічок збігалися байт у байт; це вантаж, а не функція,
# і так їх і треба називати, доки читач не зʼявиться.
