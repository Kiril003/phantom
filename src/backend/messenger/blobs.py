...
WIRE_KINDS = (
    ...
    #: Виправлений текст наявного листа. Службовий: рядка не додає.
    #: По дроту їде ЦІЛЕ нове тіло, а не різниця — кадр може приїхати
    #: вдруге, і застосування різниці подвоїло б правку.
    "edit",
...
SERVICE_KINDS = ("delete", "reaction", "edit")
