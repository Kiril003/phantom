...
async def accept_frame(
    ...
    *,
    ...
    `road` — якою дорогою кадр приїхав: direct | relay | mailbox | drop. Це не
    прикраса: точка, що чекала у скриньці чи сховку, народжується застарілою
    навіть коли доїхала за секунду після виміру, і без назви дороги сказати це
    нічим.
    """
    contact = (
