...
Знайдено 29.08.2026, коли з'ясувалось, що дріт несе рівно сім типів
(`WIRE_KINDS`), а месенджерний «хаб дій» уміє створювати дев'ять. Було так:
...
def test_a_known_kind_still_travels_untouched():
    """Спершу — що нічого не зламано для семи справжніх типів."""
