    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          {/* Схема `phantom://invite/` спільна, а мови дві. Телефон читає
              `PH2:<base64url>:<6 hex>` — рівно три частини через двокрапку
              (PeerInvite.kt). Тут же після схеми йде base64url ДВІЙКОВОГО
              конверта, у якому двокрапок нема взагалі: телефон розбере
              його на дві частини, поверне NotInvite і покаже «поганий
              код». Скло мусить сказати це наперед, а не дати людині
              рядок, який на її ж апараті не відкриється. Зворотний бік ми
              вже зробили чесним: поле «додати контакт» упізнає PH2 і веде
              на спарування. */}
          <p className="text-[11.5px] text-[#7A6A55] leading-snug mt-1">
            Це запрошення для іншого <strong>компʼютера</strong>. Свій телефон
            додають інакше — через спарування: компʼютер малює QR, телефон
            читає його камерою.
          </p>
        </div>
        {onClose && (
