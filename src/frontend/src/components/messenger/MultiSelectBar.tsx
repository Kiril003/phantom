...
export const MultiSelectBar: React.FC<MultiSelectBarProps> = ({
  ...
  return (
    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-40 bg-[#FDFCF9]/[0.97] backdrop-blur-2xl border border-[#DDD4C4] shadow-2xl rounded-2xl p-2 sm:p-2.5 flex items-center gap-1.5 sm:gap-2 animate-in fade-in slide-in-from-bottom-3 text-xs max-w-[95%] sm:max-w-xl text-[#1E2521]">
      {/* Count pill */}
      ...
      {onCalendarSync && (
        ...
        >
          <Calendar className="w-3.5 h-3.5 text-[#E87A42]" strokeWidth={1.75} />
      ...
      <button
        ...
        title="Переслати"
      >
        <Forward className="w-3.5 h-3.5" strokeWidth={1.75} />
      </button>
