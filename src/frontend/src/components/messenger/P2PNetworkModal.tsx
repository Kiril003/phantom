...
export const P2PNetworkModal: React.FC<P2PNetworkModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 phantom-scrim flex items-end sm:items-center justify-center p-0 sm:p-4 select-none animate-in fade-in duration-150">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`px-2 py-0.5 rounded-full text-[10.5px] font-bold border flex items-center gap-1.5 ${
                  diagnostics.activeStatus === 'p2p-direct'
                    ...
                    ? 'bg-[#F9F7F1] text-[#7A8479] border-[#E6DFD3]'
                    : 'bg-[#F9F7F1] text-[#C98A2E] border-[#E6DFD3]'
                }`}>
                  <span className={`w-2 h-2 rounded-full ${
                    diagnostics.activeStatus === 'p2p-direct' ? 'bg-[#E87A42]' : diagnostics.activeStatus === 'server-ws' ? 'bg-[#7A8479]' : 'bg-[#C98A2E]'
                  }`} />
                  <span>
                    {diagnostics.activeStatus === 'p2p-direct'
                      ? 'P2P Direct [WebRTC]'
            ...
            <div className="space-y-5">
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border cursor-pointer transition-all relative ${
                      diagnostics.transportMode === 'p2p'
                        ? 'bg-white border-[#4C8A55] ring-2 ring-[#4C8A55]/20 shadow-md'
                        : 'bg-white/60 border-[#DFD6C4] hover:bg-white'
                    }`}
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="w-8 h-8 rounded-xl bg-[#4C8A55]/15 text-[#4C8A55] flex items-center justify-center">
                        <ArrowDownUp className="w-4 h-4" strokeWidth={1.75} />
                      </div>
                      {diagnostics.transportMode === 'p2p' && (
                        <span className="w-2.5 h-2.5 rounded-full bg-[#4C8A55]" />
                      )}
                    </div>
                    ...
                    <div className="mt-3 pt-2 border-t border-[#F2ECE0] flex items-center gap-1.5 text-[10.5px] font-semibold text-[#4C8A55]">
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border cursor-pointer transition-all relative ${
                      diagnostics.transportMode === 'server'
                        ? 'bg-white border-[#7A8479] ring-2 ring-[#7A8479]/20 shadow-md'
                        : 'bg-white/60 border-[#DFD6C4] hover:bg-white'
                    }`}
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="w-8 h-8 rounded-xl bg-[#7A8479]/15 text-[#7A8479] flex items-center justify-center">
                        <Globe className="w-4 h-4" strokeWidth={1.75} />
                      </div>
                      {diagnostics.transportMode === 'server' && (
                        <span className="w-2.5 h-2.5 rounded-full bg-[#7A8479]" />
                      )}
                    </div>
                    ...
                    <div className="mt-3 pt-2 border-t border-[#F2ECE0] flex items-center gap-1.5 text-[10.5px] font-semibold text-[#7A8479]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                ...
                <div className="p-3 bg-white rounded-2xl border border-[#E2D8C6] shadow-2xs">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="text-xl font-black text-[#4C8A55]">{(diagnostics.bytesTransferred.p2p / 1024).toFixed(1)}</span>
                ...
                <div className="p-3 bg-white rounded-2xl border border-[#E2D8C6] shadow-2xs">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="text-xl font-black text-[#7A8479]">{(diagnostics.bytesTransferred.server / 1024).toFixed(1)}</span>
                    <span className="text-xs font-semibold text-[#79887D]">KB</span>
                  </div>
                  <span className="text-[10px] text-[#79887D] font-semibold block mt-1">
                    WebSocket sync
            ...
            <div className="space-y-3">
              ...
              {peers.length === 0 ? (
                <div className="p-8 text-center bg-white rounded-2xl border border-[#DFD6C4]">
                  <Users className="w-8 h-8 text-[#A8B6AB] mx-auto mb-2 opacity-50" strokeWidth={1.75} />
            ...
            <div className="space-y-4">
              <div className="p-3.5 bg-[#F6EEE2] rounded-2xl border border-[#E6DC source-serif]">
                <h4 className="font-bold text-xs text-[#1E2521] flex items-center gap-1.5">
                  <KeyRound className="w-4 h-4 text-[#E87A42]" strokeWidth={1.75} />
              ...
              <div className="p-4 bg-white rounded-2xl border border-[#DFD6C4] space-y-2.5">
                ...
                {manualOfferText && (
                  <div className="relative">
                    ...
                    >
                      {copiedOffer ? <Check className="w-3.5 h-3.5 text-[#4C8A55]" strokeWidth={1.75} /> : <Copy className="w-3.5 h-3.5" strokeWidth={1.75} />}
              ...
              <div className="p-4 bg-white rounded-2xl border border-[#DFD6C4] space-y-2.5">
                ...
                >
                  <Check className="w-3.5 h-3.5 text-[#4C8A55]" strokeWidth={1.75} />
