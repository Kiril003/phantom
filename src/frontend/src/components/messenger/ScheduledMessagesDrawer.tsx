      ...
      <div className="bg-[#FDFCF9] border-l border-[#DDD4C4] w-full max-w-lg h-full shadow-2xl flex flex-col select-none animate-in slide-in-from-right duration-250 text-[#1E2521]">
        ...
        <div className="p-4 sm:p-5 border-b border-[#E6DFD3] bg-[#FDFCF9] flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {/*
                Правда про час. Вузол про відкладені листи не знає нічого, а
                диспетчер живе у вкладці: лист іде, лише поки месенджер
                відкритий о тій самій хвилині, і пропущена хвилина пропущена
                назавжди. Слово «черга ... до відправки» обіцяло самостійне
                надсилання, якого вкладка виконати не може. Кажемо наперед,
                як у решті продукту.
              */}
              <p className="text-xs text-[#5F6A60]">
                Чернетки з нагадуванням про час — надсилаються вашим дотиком
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <Plus className="w-4 h-4 text-[#E87A42]" strokeWidth={1.75} />
        ...
        <div className="p-3.5 sm:p-4 border-b border-[#E6DFD3] space-y-3 bg-[#FDFCF9] shrink-0">
          ...
          <div className="relative">
            <Search className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-[#8C9A90]" strokeWidth={1.75} />
            <input
              type="text"
              value={searchQuery}
          ...
          {filteredMessages.length === 0 ? (
            <div className="py-12 px-6 text-center space-y-3">
              ...
              <p className="text-xs text-[#7A8479] max-w-xs mx-auto">
                {filterScope === 'current'
                  ? 'У цьому чаті немає відкладених чернеток. Натисніть "Створити" зверху або іконку годинника в полі вводу — лист чекатиме тут, доки ви його не надішлете.'
                  : 'Відкладених чернеток немає.'}
              </p>
              <button
