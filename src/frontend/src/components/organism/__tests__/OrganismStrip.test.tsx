...
describe('standalone-збірка Ф1', () => {
  ...
  it('Ctrl+K відкриває палітру; «Переходи» — рівно п\'ять входів', () => {
    ...
    // Ф4: п'ятий вхід зветься «Огляд» — слово «Кокпіт» тепер належить
    // столу-кокпіту, а огляд аналітики лишився досяжним під власним словом.
    for (const title of ['Мапа', 'Діалог', 'Компанія', 'Налаштування', 'Огляд']) {
