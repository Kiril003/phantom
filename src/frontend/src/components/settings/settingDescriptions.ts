...
export const SETTING_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  /* ── map: піч дорожніх пакетів ── */
  bake_min_ram_pct:
    'Поки вільної памʼяті менше за цей відсоток, піч рахує це як удар; після кількох ' +
    'поспіль (див. нижче) зупиняє себе сама — раніше, ніж сторож системи вбʼє робітника. ' +
    'Нижче 15 не буває: система стріляє на 12.',
  bake_low_strikes:
    'Скільки вимірів поспіль нижче порога піч терпить, перш ніж зупинитись: одна ' +
    'миттєва яма — не привід.',
  bake_keep_source_extracts:
    'Лишати завантажений витяг OSM на диску після випікання чи зупинки — повтор тоді ' +
    'не качає сотні мегабайтів знову. Вимкни, якщо місце дорожче за час.',
};
